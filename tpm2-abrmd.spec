...
Version  : 2.4.1
Release  : 12
URL      : https://github.com/tpm2-software/tpm2-abrmd/releases/download/2.4.1/tpm2-abrmd-2.4.1.tar.gz
Source0  : https://github.com/tpm2-software/tpm2-abrmd/releases/download/2.4.1/tpm2-abrmd-2.4.1.tar.gz
Source1  : https://github.com/tpm2-software/tpm2-abrmd/releases/download/2.4.1/tpm2-abrmd-2.4.1.tar.gz.asc
...
%prep
%setup -q -n tpm2-abrmd-2.4.1
cd %{_builddir}/tpm2-abrmd-2.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647068162
...
cp %{_builddir}/tpm2-abrmd-2.4.1/LICENSE %{buildroot}/usr/share/package-licenses/tpm2-abrmd/af62924ad3089277c413ea767486f404ac159ce1
%make_install
